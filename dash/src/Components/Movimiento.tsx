...
const Movimientos: FC = () => {
  ...
  const [movimientoEditar, setMovimientoEditar] = useState<Partial<Movimiento> | null>(null);
  const [esNuevoMovimiento, setEsNuevoMovimiento] = useState(false);
  ...
  useEffect(() => {
    const obtenerDatos = async () => {
      try {
        ...
        // Around line 94-109, update the mapping function:
              ...
              <div className="col-md-6">
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onChange={handleInputChange}
                    placeholder="Número de soporte o recibo"
                  />
                </Form.Group>
              </div>
            </div>
